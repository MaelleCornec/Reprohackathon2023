...
awk '{sub(/ .*/, ""); print}' sao00004.keg > scripts/genes/genes.csv

# Création du titre de la colonne
echo "Name" > scripts/genes/titre.csv

# Concaténation du titre et des gènes
cat scripts/genes/titre.csv scripts/genes/genes.csv > scripts/genes/translation_genes.csv

# Suppression des fichiers intermédiaires
rm sao00001.keg sao00002.keg sao00003.keg sao00004.keg scripts/genes/titre.csv scripts/genes/genes.csv